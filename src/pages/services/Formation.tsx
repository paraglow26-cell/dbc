    ...
    <div className="min-h-screen pt-36 pb-16">
      ...
      <section className="relative py-24 bg-gradient-to-br from-[#004c47] to-[#00a49a] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <span className="inline-block text-white/80 text-xs font-bold uppercase tracking-widest mb-5">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="bg-gray-50 rounded-[3rem] p-12 border border-gray-100 hover:shadow-xl transition-all h-full">
              <div className="w-16 h-16 bg-[#00a49a] rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-[#00a49a]/20">
              ...
              <ul className="space-y-4 mb-10">
                {[
                  ...
                  <li key={idx} className="flex items-start gap-4">
                    <CheckCircle2 className="w-6 h-6 text-[#00a49a] shrink-0 mt-1" />
                    <span className="text-gray-700 font-medium">{item}</span>
                  </li>
                ))}
              </ul>
              <div className="p-6 bg-[#00a49a]/5 rounded-2xl border border-[#00a49a]/10">
                <p className="text-sm font-bold text-[#00a49a] uppercase mb-2 tracking-widest">Focus Instrumentistes</p>
            ...
            <div className="bg-[#003b37] rounded-[3rem] p-12 text-white hover:shadow-xl transition-all h-full">
              <div className="w-16 h-16 bg-[#046fcc] rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-[#046fcc]/20">
              ...
              <ul className="space-y-4 mb-10">
                {[
                  ...
                  <li key={idx} className="flex items-start gap-4">
                    <CheckCircle2 className="w-6 h-6 text-[#046fcc] shrink-0 mt-1" />
                    <span className="text-white/90 font-medium">{item}</span>
                  </li>
                ))}
              </ul>
              <div className="p-6 bg-white/10 rounded-2xl border border-white/10">
                <p className="text-sm font-bold text-[#046fcc] uppercase mb-2 tracking-widest">Innovation Scientifique</p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button 
              ...
              size="lg" 
              className="bg-[#00a49a] hover:bg-[#03b0a5] text-white px-12 h-14 rounded-lg font-bold text-lg shadow-lg"
            >
              Contact Formation
            </Button>
            <Button 
              ...
              size="lg" 
              className="border-gray-200 text-gray-600 px-12 h-14 rounded-lg font-bold text-lg bg-white"
            >
              Voir la Robotique
            </Button>
          </div>
